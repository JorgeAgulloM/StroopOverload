...
class AchievementEngine {
    fun evaluate(
        ...
        tryUnlock("five_wins", career.totalGamesWon >= 10)
        tryUnlock("fifteen_wins", career.totalGamesWon >= 30)
        tryUnlock("thirty_wins", career.totalGamesWon >= 60)
        tryUnlock("fifty_wins", career.totalGamesWon >= 100)
        tryUnlock("hundred_wins", career.totalGamesWon >= 200)
        tryUnlock("two_hundred_wins", career.totalGamesWon >= 400)
        ...
        tryUnlock("flawless", career.flawlessGamesCount >= 3)
        tryUnlock("flawless_tier2", career.flawlessGamesCount >= 10)
        tryUnlock("flawless_tier3", career.flawlessGamesCount >= 30)
        tryUnlock("flawless_tier4", career.flawlessGamesCount >= 60)
        ...
        tryUnlock("streak_master", career.maxWinStreak >= 8)
        tryUnlock("streak_legend", career.maxWinStreak >= 15)
        tryUnlock("streak_god", career.maxWinStreak >= 25)

        tryUnlock("cyber_veteran", career.cyberDifficultyWins >= 35)
    ...
    fun progressFor(id: String, career: CareerStats): AchievementProgress = when (id) {
        ...
        "five_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(10), 10, "${career.totalGamesWon}/10 wins")
        "fifteen_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(30), 30, "${career.totalGamesWon}/30 wins")
        "thirty_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(60), 60, "${career.totalGamesWon}/60 wins")
        "fifty_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(100), 100, "${career.totalGamesWon}/100 wins")
        "hundred_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(200), 200, "${career.totalGamesWon}/200 wins")
        "two_hundred_wins" -> AchievementProgress.Count(career.totalGamesWon.coerceAtMost(400), 400, "${career.totalGamesWon}/400 wins")
        ...
        "flawless" -> AchievementProgress.Count(career.flawlessGamesCount.coerceAtMost(3), 3, "${career.flawlessGamesCount}/3 flawless")
        "flawless_tier2" -> AchievementProgress.Count(career.flawlessGamesCount.coerceAtMost(10), 10, "${career.flawlessGamesCount}/10 flawless")
        "flawless_tier3" -> AchievementProgress.Count(career.flawlessGamesCount.coerceAtMost(30), 30, "${career.flawlessGamesCount}/30 flawless")
        "flawless_tier4" -> AchievementProgress.Count(career.flawlessGamesCount.coerceAtMost(60), 60, "${career.flawlessGamesCount}/60 flawless")
        ...
        "streak_master" -> AchievementProgress.Count(career.maxWinStreak.coerceAtMost(8), 8, "${career.maxWinStreak}/8 streak")
        "streak_legend" -> AchievementProgress.Count(career.maxWinStreak.coerceAtMost(15), 15, "${career.maxWinStreak}/15 streak")
        "streak_god" -> AchievementProgress.Count(career.maxWinStreak.coerceAtMost(25), 25, "${career.maxWinStreak}/25 streak")
        "cyber_veteran" -> AchievementProgress.Count(career.cyberDifficultyWins.coerceAtMost(35), 35, "${career.cyberDifficultyWins}/35 cyber")
